...
import { $t as TypeValidationError, At as custom, B as isAbortError, Bt as union, Et as _null, F as filterNullable, Ft as never, It as number, K as isProviderReference, L as getRuntimeEnvironmentUserAgent, Lt as object$1, Mt as lazy, N as executeTool, Nt as literal, Ot as array$1, P as fetchWithValidatedRedirects, Pt as looseObject, R as getToolCaller, Rt as record, S as createIdGenerator, Tt as _instanceof, U as isExecutableTool, Ut as AISDKError, V as isBuffer, Vt as unknown, W as isFullMediaType, Wt as APICallError, Y as lazySchema, at as resolve, bt as zodSchema, c as DownloadError, ct as retryWithExponentialBackoff, d as asSchema, en as UnsupportedFunctionalityError, f as cancelResponseBody, gt as validateTypes, h as convertBase64ToUint8Array, i as gateway, it as readResponseWithSizeLimit, j as detectMediaType, jt as discriminatedUnion, kt as boolean, lt as safeParseJSON, n as GatewayError, q as isUrlSupported, qt as InvalidPromptError, s as DelayedPromise, t as GatewayAuthenticationError, tn as getErrorMessage, u as asArray, ut as safeValidateTypes, vt as withUserAgentSuffix, wt as _enum, y as convertUint8ArrayToBase64, zt as string } from "./@ai-sdk/gateway+[...].mjs";
...
var object = ({ schema: inputSchema, name: name23, description }) => {
...
var array = ({ element: inputElementSchema, name: name23, description }) => {
...
async function runWithTracingChannelSpan(message, execute) {
	...
	const tracingChannel = (_a23 = diagnosticsChannel == null ? void 0 : diagnosticsChannel.tracingChannel) == null ? void 0 : _a23.call(diagnosticsChannel, "ai:telemetry");
...
var ToolLoopAgent = class {
	...
	*/
	agentHeaders(preparedCall) {
		var _a23;
		return withUserAgentSuffix((_a23 = preparedCall.headers) != null ? _a23 : {}, "ai-sdk-agent/tool-loop");
	}
	/**
	...
	*/
	async generate({ abortSignal, timeout, experimental_sandbox: sandbox, onStart, experimental_onStart, onStepStart, experimental_onStepStart, onToolExecutionStart, onToolExecutionEnd, onStepEnd, onStepFinish, onFinish, onEnd = onFinish, ...options }) {
		...
		const callbackArgs = {
			...
			timeout,
			experimental_sandbox: sandbox,
			onStart: mergeCallbacks((_a23 = this.settings.onStart) != null ? _a23 : this.settings.experimental_onStart, onStart != null ? onStart : experimental_onStart),
