...
import { Bt as union, C as createJsonErrorResponseHandler, Dt as any, E as createNullLanguageModelUsage, H as isCustomReasoning, I as generateId, It as number, Lt as object, M as downloadBlob, Nt as literal, Ot as array, Pt as looseObject, Qt as TooManyEmbeddingValuesForCallError, Rt as record, St as WORKFLOW_SERIALIZE, T as createLanguageModelResponseMetadata, _ as convertToBase64, dt as serializeModelOptions, en as UnsupportedFunctionalityError, h as convertBase64ToUint8Array, kt as boolean, l as StreamingToolCallTracker, nt as postFormDataToApi, ot as resolveFullMediaType, p as combineHeaders, qt as InvalidPromptError, rt as postJsonToApi, tt as parseProviderOptions, v as convertToFormData, vt as withUserAgentSuffix, w as createJsonResponseHandler, wt as _enum, x as createEventSourceResponseHandler, xt as WORKFLOW_DESERIALIZE, yt as withoutTrailingSlash, z as getTopLevelMediaType, zt as string } from "./@ai-sdk/gateway+[...].mjs";
...
function createOpenAICompatible(options) {
	...
	const getHeaders = () => withUserAgentSuffix(headers, `ai-sdk/openai-compatible/3.0.25`);
