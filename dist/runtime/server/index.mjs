...
import { D as defaultSettingsMiddleware, et as wrapLanguageModel } from "./_libs/ai.mjs";
			...
			if (provider === "chatgpt") {
				...
				if (typeof init?.body === "string") {
					...
					if (Array.isArray(body.input)) body.input = body.input.map((item) => {
						...
						if (inlineItem.role === "assistant" && Array.isArray(inlineItem.content)) return {
							role: "user",
							content: inlineItem.content.map((part) => typeof part === "object" && part !== null && !Array.isArray(part) && part.type === "output_text" ? {
								type: "input_text",
...
//#endregion
//#region .eve/builds/msk8rcx4-d8dfdb99-85eb-4105-85dc-e05432d51e0e/host/compiled-artifacts-bootstrap.mjs
...
//#endregion
//#region .eve/builds/msk8rcx4-d8dfdb99-85eb-4105-85dc-e05432d51e0e/workflow/workflows.mjs
...
//#endregion
//#region .eve/builds/msk8rcx4-d8dfdb99-85eb-4105-85dc-e05432d51e0e/nitro/workflow/workflows-handler.mjs
...
//#endregion
//#region .eve/builds/msk8rcx4-d8dfdb99-85eb-4105-85dc-e05432d51e0e/host/compiled-artifacts-workflow-world.mjs
